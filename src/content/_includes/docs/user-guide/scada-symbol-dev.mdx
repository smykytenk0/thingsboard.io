...
- **Create Widget** - this button allows you to quickly create a widget based on your SCADA symbol. Any major changes to the SCADA symbol will automatically reflect in the <DocLink product={props.product} path="user-guide/widget-library" bold={false}>widget library</DocLink>, except for fields like title, description, and search tags, which are copied at the moment you create the widget.
